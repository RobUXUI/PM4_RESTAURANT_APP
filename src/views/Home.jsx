...
import './Home.css';
// import Products from './Products'; // Si necesitas utilizar Products, descomenta esta línea
import Button from 'react-bootstrap/Button'; // Si necesitas utilizar Button, asegúrate de importarlo correctamente

const Home = () => {
    return (
        <Container>
            <Row className="mb-3"> {/* Elimina "row-gap-3" si no es una clase válida */}
                <Col md={6} className="p-5"> {/* Asegúrate de especificar el tamaño de la columna, como md={6} */}
                    <div>
                        <h2>Best choice</h2>
                    </div>
                    <div>
